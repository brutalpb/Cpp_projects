...
private:
    ...
    int city_count = 4;
    int doc_count = 4;
    string docname[20] = {"Pankaj", "Nayan", "Pawan", "Harshal"};
    string docpass[20] = {"69", "1000", "99", "55"};
    int idpass[20] = {1, 2, 3, 4};
    string docmob[20] = {"899950", "356483", "459688", "7942434"};
    int age[20] = {25, 30, 60, 50};
    string Pname[20][20], P_age[20][20], Pmobile[20][20];
...
void Hospital::patient() {
    ...
    if (pLOg == 1)
    {
        ...
        if (found2)
        {
            ...
            // string cityName[] = {"nagpur", "mumbai", "delhi", "pune"};
            // string docname1[] = {"Pankaj", "Nayan", "pawan", "Harshal"};

            int city1;
            // len = sizeof(cityName) / sizeof(cityName[0]);
...
void Hospital::doctor() {
    ...
    if (n == 1)
    {
        ...
        bool found = false;
        // int doc_pass_len = sizeof(docname) / sizeof(docname[0]);
        cout << doc_count << endl;
